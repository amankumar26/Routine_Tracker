...
const AddRoutineModal = ({ isOpen, onClose, onAdd, onEdit, routineToEdit }) => {
                    ...
                    >
                        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-md p-6 pointer-events-auto mx-4 my-auto transition-colors duration-300">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{routineToEdit ? 'Edit Routine' : 'New Routine'}</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">What do you want to do?</label>
                                    <input
                                        type="text"
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center"
                                >
                                    <Plus size={20} className="mr-2" />
                                    {routineToEdit ? 'Save Changes' : 'Add Routine'}
                                </button>
                            </form>
                        </div>
                    </motion.div>
